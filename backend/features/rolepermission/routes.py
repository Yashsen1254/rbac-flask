...
from features.rolepermission.controller import add_rolepermission_controller, display_rolepermission_controller, display_rolepermission_by_id_controller, update_rolepermission_controller, delete_rolepermission_controller
...
rolepermission_bp.route("/rolepermission/display/<int:rolepermission_id>", methods=["GET"])(display_rolepermission_by_id_controller)
